...
const CourseCardAdmin = ({ course, action }: { course: any; action: (id: any) => void }) => {
  return (
    <div className="card bg-dark border-0 shadow-lg rounded-4 overflow-hidden" style={{ width: "19rem" }}>
      ...
      <div className="card-body bg-dark text-white p-3">
        ...
        <div className="d-flex justify-content-between align-items-center mt-3">
          ...
          <button className="btn btn-danger btn-sm rounded-pill px-3 d-flex align-items-center gap-1" onClick={()=>action(course?.id)}>
            Del
          </button>
        </div>
      </div>
