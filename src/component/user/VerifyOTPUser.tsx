...
import {  verifyOTPUserURL } from '../../services/apiFetch';
...
const {register,handleSubmit,reset,formState:{errors}}=useForm({resolver:yupResolver(schema)})
    const onSubmit =async (data:any)=>{
        try{
          const res= await verifyOTPUserURL(data);
        if(res?.success){
        ...
        <div className="row" style={{height:"100%"}}>
            <div className="col-sm-6" style={{background:"rgba(6, 107, 201, 0.31)"}}>
                <div className='container position-relative  d-flex justify-content-center align-items-center flex-wrap ' style={{height:"100%",width:"80%"}}>
                    <img src="https://themes.stackbros.in/eduport_ng/assets/images/element/02.svg" alt="" className='img-fliud mt-5' style={{height:"70%",width:"100%"}}/>
            ...
            <div className="col-sm-6">
                <div className="container mx-auto my-5" style={{width:"60%"}}>
                    <h1 className='text-light'>Reset User Password</h1>
                    <form action="" onSubmit={handleSubmit(onSubmit)}>
                       ...
                       <div className="row">
                        ...
                        onClick={()=>navigate("/user-get-otp")}>Resend OTP</button></div>
