    ...
    <>
      <div className="container py-5 my-3" style={{minHeight:'250px'}}>
        <div className="row h-100 g-3">
            ...
            <div className="col-sm-3">
                <div className="container-fluid d-flex justify-content-start align-items-center flex-wrap rounded p-1" style={{background:" rgba(4, 172, 191, 0.37)",color:"rgb(4, 172, 191)"}}>
